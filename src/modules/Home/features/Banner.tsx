...
const Banner = () => {
    return (
        <div className='bg-[#f7f5ff] h-[95vh] w-full'>
            <svg
            ...
            <div className='w-full h-full flex items-center justify-center relative overflow-hidden'>
                <Image
                    src={"https://media.beehiiv.com/cdn-cgi/image/fit=scale-down,onerror=redirect,format=auto,width=1920,quality=75/www/homepage/MobileHero.png"} alt=""
                    width={800}
                    height={500}
                    className='w-[80%] object-cover spin-slow'
                />
                <div     className="absolute">
                    <h1 className="font-clashDisplay text-cyber-link uppercase font-bold text-[2.75rem] md:text-7xl lg:text-[4rem] xl:text-[5.75rem] max-w-4xl mx-auto text-center z-10">
                        THE NEWSLETTER PLATFORM FOR
